...
ALTER USER 'root'@'%' IDENTIFIED WITH mysql_native_password BY '${var.password_1}';

CREATE USER 'bear'@'%' IDENTIFIED WITH mysql_native_password BY 'link';
GRANT ALL PRIVILEGES ON *.* TO 'bear'@'%';
FLUSH PRIVILEGES;
"
